...
namespace Blazor_E_Commerce.Server.Data;
...
public class DataContext : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        .HasMany(c => c.Products) // Collection navigation property on Category
        .WithOne(p => p.Category) // Reference navigation property on Product
        .HasForeignKey(p => p.CategoryId); // Foreign key property on Product
