...
namespace Blazor_E_Commerce.Server.Migrations
{
    ...
    [Migration("20231105162249_StatsTable")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Blazor_E_Commerce.Shared.ProductVariant", b =>
                {
            ...
            modelBuilder.Entity("Blazor_E_Commerce.Shared.Stats", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Blazor_E_Commerce.Shared.ProductVariant", b =>
                {
                    b.HasOne("Blazor_E_Commerce.Shared.Edition", "Edition")
                        .WithMany()
                        .HasForeignKey("EditionId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Blazor_E_Commerce.Shared.Product", "Product")
                        .WithMany("Variants")
